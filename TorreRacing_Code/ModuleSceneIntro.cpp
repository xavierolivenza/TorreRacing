...
bool ModuleSceneIntro::Start()
{
	...
	//------------------Chickens------------------//
	//--------------------------------------------//
	chickens_dynamic_array.PushBack(new Chicken(0, CHICKEN_Y_FLOOR, 30, this));
	chickens_dynamic_array.PushBack(new Chicken(5, CHICKEN_Y_FLOOR, 70, this));
	...
	chickens_dynamic_array.PushBack(new Chicken(-452.5, 10.69, -104.15, this));
	chickens_dynamic_array.PushBack(new Chicken(-452.5, 36.46, -200.28, this));
	...
	chickens_dynamic_array.PushBack(new Chicken(-407.5, 78.52, -290.48, this));
	chickens_dynamic_array.PushBack(new Chicken(-407.5, 36.46, -200.28, this));
	...
	chickens_dynamic_array.PushBack(new Chicken(-293.14, CHICKEN_Y_FLOOR, -318.46, this));
